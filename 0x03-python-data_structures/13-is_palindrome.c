...
/**
  * get_nodeint_at_index - Gets a node from a linked lists
  * @head: The head of the linked lists
  * @index: The index to find in the linked lists
  *
...
/**
  * slistint_len - Counts the number of elements in a linked lists
  * @h: The linked lists to count
  *
